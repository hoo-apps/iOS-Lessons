...
class HOOAddPersonViewController : UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate {
    ...
    @IBAction func doneSelected(sender: UIButton)
    {
        ...
        let hoosPerson = PFObject(className:"Person")
        hoosPerson["compID"] = compIDInput?.text
        hoosPerson["funFact"] = funFactInput?.text
        hoosPerson["name"] = nameInput?.text
        hoosPerson.saveInBackgroundWithBlock {
